"""
Lead processing API endpoints for the AI Lead Intake and Qualification Automation.
"""
...
def process_lead_endpoint(lead: LeadInput) -> LeadProcessingResponse:
    """Process a lead through validation, AI analysis, scoring, and Notion storage."""
